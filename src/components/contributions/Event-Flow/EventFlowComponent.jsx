  ...
  return (
    <>
      <div className="my-20 text-[#FFFFFF] text-center">
        <h1 className="xl:text-[70px] 2xl:text-[96px] font-[700]">EVENT FLOW</h1>
      </div>
      ...
      <div className="mx-auto ">
        <div className="mx-auto relative xl:w-[1080px] 2xl:w-[1300px]">
          ...
          <div className="absolute flex xl:top-10 2xl:top-20 xl:right-[16%] xl:left-[1px] justify-start xl:h-[53%] 2xl:h-auto">
            <div>
